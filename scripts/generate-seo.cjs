...
const staticPages = [
  ...
  { path: '/all-guides', priority: 0.9, changefreq: 'weekly' },
  { path: '/loan-rejection-guides', priority: 0.85, changefreq: 'weekly' },
  { path: '/financial-health-tools', priority: 0.85, changefreq: 'weekly' },
  { path: '/cibil-score-guides', priority: 0.85, changefreq: 'weekly' },
  { path: '/bank-statement-analysis', priority: 0.85, changefreq: 'weekly' },
  { path: '/loan-eligibility-center', priority: 0.85, changefreq: 'weekly' },
  { path: '/emi-education-hub', priority: 0.85, changefreq: 'weekly' },
