...
const SolutionSection = () => {
  ...
  return (
    <section id="solution" className="bg-[#0A0A0F] py-[100px]">
      <div className="container mx-auto px-6 text-center">
        <FadeUp>
          ...
          {/* Subhead */}
          <p className="font-['DM_Sans'] font-normal text-[17px] leading-[1.6] text-[#888899] max-w-[520px] mx-auto mb-[56px]">
        ...
        <div className="grid sm:grid-cols-2 gap-6 max-w-4xl mx-auto">
          {features.map((f, i) => (
            <FadeUp key={i} delay={i * 0.1}>
              <div
                className="group relative rounded-2xl border border-[rgba(255,255,255,0.08)] bg-[#111118] p-8 hover:border-[rgba(255,255,255,0.18)] transition-all duration-300 text-left h-full"
              >
                ...
                <h3 className="text-lg font-['DM_Sans'] font-semibold text-[#F0F0F0] mb-2">{f.title}</h3>
                <p className="text-sm font-['DM_Sans'] text-[#888899] leading-relaxed">{f.description}</p>
              </div>
            </FadeUp>
          ))}
        </div>
