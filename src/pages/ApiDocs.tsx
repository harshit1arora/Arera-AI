           ...
           <div className="space-y-8">
             <div>
               ...
               <ul className="space-y-3">
                 ...
                 <li><a href="#idempotency" className="text-sm font-medium text-muted-foreground hover:text-white flex items-center gap-2"><Clock size={14} /> Idempotency</a></li>
                 <li><a href="#errors" className="text-sm font-medium text-muted-foreground hover:text-white flex items-center gap-2"><AlertCircle size={14} /> Error Codes</a></li>
               </ul>
             </div>
             <div>
               <h4 className="text-[10px] font-black text-muted-foreground uppercase tracking-[0.2em] mb-4">Endpoints</h4>
               <ul className="space-y-3">
                 <li><a href="#analyze" className="text-sm font-medium text-white flex items-center gap-2"><Zap size={14} /> Run Analysis</a></li>
                 <li><a href="#webhooks" className="text-sm font-medium text-muted-foreground hover:text-white flex items-center gap-2"><Webhook size={14} /> Webhooks</a></li>
               </ul>
             </div>
           </div>
        </aside>
        ...
        <main className="flex-1 flex flex-col lg:flex-row">
          ...
          <div className="flex-1 p-8 lg:p-16 max-w-3xl border-r border-white/5">
            ...
            <section id="analyze" className="mb-24 scroll-mt-24">
              ...
              <div className="space-y-8">
                <div>
                  <h4 className="text-[10px] font-black uppercase tracking-widest text-white/40 mb-4">Request Parameters</h4>
                    ...
                    {[
                      ...
                      <div key={param.name} className="flex gap-4">
                        ...
                        <div className="flex-1">
                          <span className="text-[10px] font-bold text-white/30 uppercase mr-2">{param.type}</span>
              ...
              <div className="overflow-hidden border border-white/5 rounded-2xl">
                <table className="w-full text-left text-sm">
                  <thead className="bg-white/5">
                    <tr>
                      <th className="p-4 font-black uppercase tracking-widest text-[10px] text-white/40">Code</th>
                      <th className="p-4 font-black uppercase tracking-widest text-[10px] text-white/40">Description</th>
                    </tr>
                  </thead>
          ...
          <div className="lg:w-[450px] xl:w-[550px] bg-[#0d1117] p-8 lg:p-12 sticky top-16 h-[calc(100vh-4rem)] overflow-y-auto hidden lg:block">
            <div className="mb-8">
              ...
              <div className="rounded-2xl bg-black/40 border border-white/5 p-6 font-mono text-[13px] leading-relaxed relative overflow-hidden group">
            ...
            <div className="space-y-6">
              <h4 className="text-[10px] font-black uppercase tracking-widest text-white/30">Response Example</h4>
              <div className="rounded-2xl bg-black/40 border border-white/5 p-6 font-mono text-[13px] leading-relaxed text-primary/80">
                <pre>{`{
  "decision": "APPROVE",
  "credit_limit": 240000,
  "risk_score": 74,
