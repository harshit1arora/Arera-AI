...
export const MOCK_BANK_ACCOUNTS: BankAccount[] = [
  {
    ...
    ifscCode: "HDFC0001234",
    bankName: "HDFC Bank",
    accountHolderName: "Arera Financial Services Pvt. Ltd.",
    balance: 42568320,
...
export const MOCK_COMM_LOGS: CommLog[] = [
  ...
  { id: "COM-005", disbursementId: "D-4824", borrowerName: "Sunita Devi Verma", type: "Email", recipient: "sunita.verma@gmail.com", template: "Rejection Notice", status: "Failed", sentAt: "2026-05-03T11:05:00Z", message: "We were unable to process your transfer. Please contact support at support@arera.ai." },
];

export const MOCK_COMM_TEMPLATES: CommTemplate[] = [
  { id: "TPL-001", name: "Loan Approval", type: "SMS", trigger: "Approval", body: "Dear {name}, your loan of Rs.{amount} (Ref: {loanId}) has been approved by Arera Financial. Agreement document sent to your email.", isActive: true },
